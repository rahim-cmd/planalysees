                    ...
                    <div className="carousel-item active">
                        ...
                        <div className="carousel-caption">
                            ...
                            <div className="d-flex justify-content-center">
                                <Link className="btn btn-primary d-flex py-3 px-5 me-2 flex-shrink-0 fadeInUp animate__animated" data-animation="fadeInUp" data-delay='1.5s' style={{animationDelay: '1.7s'}} to="#">Apply Now</Link>
                                <Link className="btn btn-secondary d-inline-block py-3 px-5 ms-2 flex-shrink-0 fadeInUp animate__animated" data-animation="fadeInUp" data-delay='1.5s' style={{animationDelay: '1.7s'}} to="#">Read More</Link>
                            </div>
                        </div>
                    </div>
